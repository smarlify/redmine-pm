...
require_dependency 'redmine_by_smarlify/services/s3_storage'
        ...
        base.class_eval do
          ...
          def diskfile
            ...
            if s3_enabled? && !File.exist?(local_path) && s3_key.present?
              if RedmineBySmarlify::Services::S3Storage.file_exists?(s3_key)
                FileUtils.mkdir_p(File.dirname(local_path))
                if RedmineBySmarlify::Services::S3Storage.download_file(s3_key, local_path)
          ...
          def s3_url
            ...
            RedmineBySmarlify::Services::S3Storage.presigned_url(s3_key)
          end
          ...
          def upload_to_s3
            ...
            if RedmineBySmarlify::Services::S3Storage.upload_file(local_file, s3_path, content_type)
          ...
          def delete_from_s3
            ...
            if RedmineBySmarlify::Services::S3Storage.delete_file(s3_key)
...
# Apply the patch to Attachment
Attachment.include(RedmineBySmarlify::Patches::AttachmentPatch)
